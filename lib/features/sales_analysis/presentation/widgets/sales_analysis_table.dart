        ...
        child: Padding(
          ...
          child: Text(
            'No sales data available.'
                .tr(), // Or your preferred empty state message
        ...
        children: [
          ...
          TableRow(
            ...
            children: [
              ...
              ), // Center align header for button column
              _buildHeaderCell(
                'Discount'.tr(),
                theme,
                textAlign: TextAlign.end,
              ), // Align numeric headers to end
              _buildHeaderCell(
                'Total'.tr(),
                theme,
                textAlign: TextAlign.end,
          ...
          ...entries.map((entry) {
            return TableRow(
              ...
              children: [
                ...
                _buildDataCell(
                  Text(
                    DateFormat.Md(context.locale.toString()).format(entry.date),
                  ),
                  theme,
                ...
                _buildDataCell(
                  Center(
                    ...
                    child: TextButton(
                      onPressed:
                          () => _showItemsDialog(context, entry.items, theme),
                ...
                _buildDataCell(
                  Text(
                    entry.total.toStringAsFixed(
                      context.locale.languageCode == 'ar' ? 1 : 2,
                    ), // Adjust precision based on locale
